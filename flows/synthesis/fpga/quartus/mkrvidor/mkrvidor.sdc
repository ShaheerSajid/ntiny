...
# Create Clock
#**************************************************************
create_clock -name {CLOCK_8} -period 125.000ns -waveform { 0.000 62.500 } [get_ports {iCLK}]
...
#**************************************************************
create_generated_clock -name {CLOCK_25} -source [get_pins {pll_25_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 25 -divide_by 8 -master_clock {CLOCK_8} [get_pins {pll_25_inst|altpll_component|auto_generated|pll1|clk[0]}] 
