...
\diagram{icache}{\texttt{icache} datapath. Left: CPU/fetch and RAM inputs.
...
\subsection{Ports}
\begin{center}\small
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{3.9cm} l Y}
\toprule
...
\diagram{icache-fsm}{\texttt{icache} fill FSM. A hit is served from
