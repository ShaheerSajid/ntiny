...
assign epc_o = pc_i;
assign ecause_o = {24'h800000, exception_code};
// MTVEC MODE: [0]=0 Direct (all traps to BASE), [0]=1 Vectored (BASE + 4*cause)
wire [31:0] base_addr = {vec_i[31:2], 2'b00};
assign handler_addr_o = vec_i[0] ? (base_addr + {24'b0, exception_code, 2'b00}) : base_addr;
