...
// Tracer/log code lives in the testbench (flows/simulation/testbench/
// tb_tracer.sv), reaching into core_top via hierarchical refs. The
// design carries zero trace footprint.
